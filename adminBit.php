         ...
         if ($show_products->rowCount() > 0) {
            while ($fetch_products = $show_products->fetch(PDO::FETCH_ASSOC)) {
               ...
               if ($fetch_products['bid_await'] == "await") {
                  echo "<tr><td>" . $fetch_products['id'] . "<td/<td>" . $fetch_products['symbol'] . "<td/<td>" . $fetch_products['price'] . "<td/<td>" . $fetch_products['profit'] . "<td/<td>" . $fetch_products['bid_user']."<td/<td>" . $fetch_products['bid_value']. "<td/<td>" . $fetch_products['date_created']. "<td/<td>" . $fetch_products['bid_end_datetime'];
               }
            }
            echo "</table>";
         ?>
